cfg_if! {
    if #[cfg(all(target_arch = "wasm32", feature = "wbindgen"))] {
        ...
        pub use self::wasm_bindgen::packet_receiver::PacketReceiver;
        ...
        pub use self::miniquad::packet_receiver::PacketReceiver;
        pub use self::miniquad::client_socket::ClientSocket;
    }
    else {
        mod native;
        pub use self::native::packet_sender::PacketSender;
        pub use self::native::packet_receiver::PacketReceiver;
